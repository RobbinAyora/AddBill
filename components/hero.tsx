...
const slides = [
  {
    ...
    heading: "Precision Cost Estimation",
    subheading: "Accurate cost plans and bills of quantities that give your project a solid financial foundation from day one.",
    button: "Get a Quote",
    buttonLink: "/contact",
  },
  {
  ...
  },
  {
    ...
    heading: "Reliable Project Valuation",
    subheading: "Transparent cost control and payment certification that keeps your project on budget throughout.",
    button: "Contact Us",
    buttonLink: "/contact",
  },
]
